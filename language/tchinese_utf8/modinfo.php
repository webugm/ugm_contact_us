...
define('_MI_UGMCONTACTUS_RECAPTCHA_ENABLE' , '是否使用Google驗證?');
define('_MI_UGMCONTACTUS_RECAPTCHA_ENABLE_DESC' , "<a href='https://www.ugm.com.tw/modules/tad_book3/page.php?tbdsn=862' target='_blank'>申請Google reCAPTCHA 教學</a>");
define('_MI_UGMCONTACTUS_RECAPTCHA_SITEKEY' , 'sitekey');
define('_MI_UGMCONTACTUS_RECAPTCHA_SITEKEY_DESC' , '請輸入「sitekey」');

define('_MI_UGMCONTACTUS_RECAPTCHA_SECRETKEY' , 'secretkey');
define('_MI_UGMCONTACTUS_RECAPTCHA_SECRETKEY_DESC' , '請輸入「secretkey」');
